...
##############################################
# CatsTrie:                                  #
# An algorithm that will auto complete the   #
# an input sentence using the data in a list #
# of sentence .                              #
##############################################
...
if __name__ == '__main__':
    ...
    # A simple example
    prompt = "ab"
    print("Example 1.1: "+ str(mycattrie.autoComplete(prompt)))
    #output abazacy
    ...
    prompt = "dbcef"
    print("Example 1.3: "+ str(mycattrie.autoComplete(prompt)))
    #output dbcef

    # Example 1.4
    # What if the length is longer?
    prompt = "dbcefz"
    print("Example 1.4: "+ str(mycattrie.autoComplete(prompt)))
    #output None

    # Example 1.5
    # What if sentences doesn’t exist.
    prompt = "ba"
    print("Example 1.5: "+ str(mycattrie.autoComplete(prompt)))
    #output None

    # Example 1.6
    # A scenario where the tiebreaker is used
    prompt = "x"
    print("Example 1.6: "+ str(mycattrie.autoComplete(prompt)))
    #output xyz

    # Example 1.7
    # A scenario where the prompt is empty
    prompt = ""
    print("Example 1.7: "+ str(mycattrie.autoComplete(prompt)))
    #output abazacy
    ...
    prompt = "abc"
    print("Example 2.1: "+ str(mycattrie.autoComplete(prompt)))
    #output abczacy
