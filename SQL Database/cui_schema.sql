...
--   at:        2023-05-03 14:34:56 SGT
--   site:      Oracle Database 12c
--   type:      Oracle Database 12c

--Group:T1_Group04
--Group members:Chong Jin Yao, Heng Zi Ying, Mark Gabriel Sta. Ana Manlangit
...
CREATE TABLE authorised_driver (
    ...
    ad_approval_date DATE NOT NULL
);
...
CREATE TABLE bin (
    ...
    bin_type_size          NUMBER(4) NOT NULL,
    waste_type_id          VARCHAR2(50) NOT NULL,
...
CREATE TABLE bin_collection_record (
    ...
    bin_collection_collected_kgs NUMBER(3),
    bin_collection_overweight    CHAR(1) NOT NULL
);
...
ALTER TABLE bin_collection_record ADD CONSTRAINT bin_collection_record_pk PRIMARY KEY
( bin_rfid,
                                                                                  collection_date
                                                                                  );
...
CREATE TABLE bin_type (
    bin_type_size        NUMBER(4) NOT NULL,
    waste_type_id        VARCHAR2(50) NOT NULL,
    bin_type_supply_cost NUMBER(7, 2) NOT NULL
);
...
CREATE TABLE contract_detail (
    waste_type_id       VARCHAR2(50) NOT NULL,
    contract_no         NUMBER(7) NOT NULL,
    c_d_collection_cost NUMBER(7, 2) NOT NULL,
    c_d_collection_freq VARCHAR2(11) NOT NULL
);
...
CREATE TABLE driver (
    driver_no         NUMBER(7) NOT NULL,
    driver_license_no CHAR(9) NOT NULL,
    driver_name       VARCHAR2(50) NOT NULL,
    driver_dob        DATE NOT NULL,
    driver_tax_no     CHAR(9) NOT NULL,
...
CREATE TABLE street (
    ...
    street_surface_type VARCHAR2(8) NOT NULL,
...
ALTER TABLE waste_type ADD CONSTRAINT waste_type_nk UNIQUE ( waste_type_description );
