...
//        String data = sharedPreferences.getString("EVENTS", "DEFAULT VALUE");
//        ArrayList<Event> eventDetails;
//        if (data.equals("DEFAULT VALUE")) {
//            eventDetails = new ArrayList<>();
//        } else {
//            Type type = new TypeToken<ArrayList<Event>>() {}.getType();
//            eventDetails = gson.fromJson(data, type);
//        }
//
//        // Set up RecyclerView Adapter
//        recyclerAdapter = new MyEventRecyclerAdapter(eventDetails);
//        recyclerAdapter.setData(eventDetails);
//        recyclerView.setAdapter(recyclerAdapter);
//
//    }
}